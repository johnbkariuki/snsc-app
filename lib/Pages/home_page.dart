  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedLabelStyle: TextStyle(fontFamily: Preferences.currentFont(),),
        unselectedLabelStyle: TextStyle(fontFamily: Preferences.currentFont(),),
        ...
        onTap: _onItemTapped,
        iconSize: 36,
        backgroundColor: Preferences.usingDarkMode() ? Colors.black : Colors.white,
      ),
    );
  }
}
